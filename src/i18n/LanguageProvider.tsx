...
const ar: Record<string, string> = {
  ...
  "Open player account menu": "فتح قائمة حساب اللاعب",
  "Player account": "حساب اللاعب",
  "Upload profile photo": "رفع صورة الملف الشخصي",
  ...
  "The profile photo must be 5 MB or smaller.": "يجب ألا يزيد حجم صورة الملف الشخصي عن 5 ميجابايت.",
  "Could not update the profile photo.": "تعذر تحديث صورة الملف الشخصي.",

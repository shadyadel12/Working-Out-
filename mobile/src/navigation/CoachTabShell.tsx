...
function BuildStack() {
  ...
  return <Stack.Navigator screenOptions={stackOptions(theme)}><Stack.Screen name="BuildHome" component={BuildHomeScreen} options={{ headerShown: false }} /><Stack.Screen name="ClientPlans" component={CoachPlanScreen} options={{ title: tr('Client programming', language), headerShown: false }} /><Stack.Screen name="Exercises" component={ExerciseLibraryScreen} options={{ title: tr('Exercises', language) }} /><Stack.Screen name="Workouts" component={WorkoutLibraryScreen} options={{ title: tr('Workouts', language) }} /><Stack.Screen name="Programs" component={ProgramLibrary} options={{ title: tr('Programs', language) }} /><Stack.Screen name="DietTemplates" component={DietLibraryScreen} options={{ title: tr('Diet templates', language) }} /></Stack.Navigator>;
}
...
function SettingsStack() {
  const theme = useMobileTheme();
  const { language } = useLanguage();
  return <Stack.Navigator screenOptions={stackOptions(theme)}><Stack.Screen name="SettingsHome" component={SettingsHomeScreen} options={{ headerShown: false }} /><Stack.Screen name="Appearance" component={AppearanceSettingsScreen} options={{ title: tr('Appearance', language) }} /><Stack.Screen name="CommandCenter" component={CoachDashboardScreen} options={{ title: tr('Command center', language), headerShown: false }} /><Stack.Screen name="Checkups" component={CoachCheckupsScreen} options={{ title: tr('Daily check-ups', language), headerShown: false }} /><Stack.Screen name="CoachTeam" component={CoachTeam} options={{ title: tr('Coach team', language) }} /><Stack.Screen name="CoachSupport" component={CoachSupportScreen} options={{ title: tr('Admin support', language), headerShown: false }} /><Stack.Screen name="CoachTools" component={CoachMoreActiveScreen} options={{ title: tr('Coach tools', language), headerShown: false }} /></Stack.Navigator>;
}

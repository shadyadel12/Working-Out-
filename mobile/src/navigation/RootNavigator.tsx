...
function AdminTabs(){return <Tabs.Navigator screenOptions={tabOptions}><Tabs.Screen name="Overview" component={AdminOverviewScreen}/><Tabs.Screen name="Users & Keys" component={AdminScreen}/><Tabs.Screen name="Support" component={AdminSupportScreen}/><Tabs.Screen name="Account" component={AccountScreen}/></Tabs.Navigator>}
